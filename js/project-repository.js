...
export const createClientResponseRequest = ({ projectId, taskId, title, instructions, requestType, dueOn, requiresArtifact, requiresSignedArtifact, approvalSubject, approvalVersion }) => callMutation('create_client_response_request', { p_project: projectId, p_task: taskId || null, p_title: title, p_instructions: instructions || '', p_request_type: requestType, p_due_on: dueOn || null, p_requires_artifact: requiresArtifact, p_requires_signed_artifact: requiresSignedArtifact, p_approval_subject: approvalSubject || null, p_approval_version: approvalVersion || null });
